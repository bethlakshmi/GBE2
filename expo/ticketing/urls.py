...
urlpatterns = patterns('',
                       url('^ticketing/$',
                           views.index,
                           name='index'),
                       url(r'^ticketing/ticket_items/(?P<conference_choice>[-\w]+)/?$',
                           views.ticket_items,
                           name='ticket_items'),
                       url(r'^ticketing/ticket_items/?$',
                           views.ticket_items,
                           name='ticket_items'),
                       url(r'^ticketing/ticket_item_edit/?$',
                           views.ticket_item_edit,
                           name='ticket_item_edit'),
                       url(r'^ticketing/ticket_item_edit/(?P<item_id>\d+)/?$',
                           views.ticket_item_edit,
                           name='ticket_item_edit'),
                       url(r'^ticketing/bptevent_edit/(?P<event_id>\d+)/?$',
                           views.bptevent_edit,
                           name='bptevent_edit'),
                       url(r'^ticketing/transactions/?$',
                           views.transactions,
                           name='transactions'),
                       )
