...
class Profile(WorkerItem):
    ...
    def bids_to_review(self):
        ...
        if 'Vendor Reviewers' in self.privilege_groups:
            from vendor import Vendor  # late import, circularity
    ...
    def get_troupes(self):
        from troupe import Troupe  # late import, circularity
        solos = self.personae.all()
        performers = list()
        for solo in solos:
    ...
    def get_combos(self):
        from combo import Combo  # late import, circularity
        solos = self.personae.all()
        performers = list()
        for solo in solos:
    ...
    def get_shows(self):
        from show import Show  # late import, circular dependency
        acts = self.get_acts()
