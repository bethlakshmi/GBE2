...
# acts
                        ...
                        url(r'^act/reviewlist/?$',
                            views.review_act_list, name = 'act_review_list'),
...
#proposals
                        ...
                        url(r'^classpropose/review/?$',
                            views.review_proposal_list, name = 'propose_review'),
                        url(r'^classpropose/review/(\d+)/?$',
...
# personae
                        ...
                        url(r'^troupe/create/?$',
                            views.create_troupe, name = 'troupe_create'),
                        url(r'^combo/create/?$',
