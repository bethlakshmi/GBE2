...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.e_title'
        db.add_column(u'gbe_event', 'e_title',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=128),
                      keep_default=False)

        # Adding field 'Event.e_description'
        db.add_column(u'gbe_event', 'e_description',
                      self.gf('django.db.models.fields.TextField')(default='a'),
                      keep_default=False)

        # Adding field 'Event.e_conference'
        db.add_column(u'gbe_event', 'e_conference',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='e_conference_set', to=orm['gbe.Conference']),
                      keep_default=False)

        # Adding field 'Biddable.b_title'
        db.add_column(u'gbe_biddable', 'b_title',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=128),
                      keep_default=False)

        # Adding field 'Biddable.b_description'
        db.add_column(u'gbe_biddable', 'b_description',
                      self.gf('django.db.models.fields.TextField')(default='a', blank=True),
                      keep_default=False)

        # Adding field 'Biddable.b_conference'
        db.add_column(u'gbe_biddable', 'b_conference',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='b_conference_set', to=orm['gbe.Conference']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.e_title'
        db.delete_column(u'gbe_event', 'e_title')

        # Deleting field 'Event.e_description'
        db.delete_column(u'gbe_event', 'e_description')

        # Deleting field 'Event.e_conference'
        db.delete_column(u'gbe_event', 'e_conference_id')

        # Deleting field 'Biddable.b_title'
        db.delete_column(u'gbe_biddable', 'b_title')

        # Deleting field 'Biddable.b_description'
        db.delete_column(u'gbe_biddable', 'b_description')

        # Deleting field 'Biddable.b_conference'
        db.delete_column(u'gbe_biddable', 'b_conference_id')
    ...
    models = {
        ...
        u'gbe.biddable': {
            ...
            'b_conference': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'b_conference_set'", 'to': u"orm['gbe.Conference']"}),
            'b_description': ('django.db.models.fields.TextField', [], {'default': "'a'", 'blank': 'True'}),
            'b_title': ('django.db.models.fields.CharField', [], {'default': "'a'", 'max_length': '128'}),
        ...
        u'gbe.costume': {
            'Meta': {'object_name': 'Costume', '_ormbases': [u'gbe.Biddable']},
            ...
            'performer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gbe.Persona']", 'null': 'True', 'blank': 'True'}),
            ...
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'costumes'", 'to': u"orm['gbe.Profile']"})
        },
        u'gbe.cueinfo': {
        ...
        u'gbe.event': {
            ...
            'e_conference': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'e_conference_set'", 'to': u"orm['gbe.Conference']"}),
            'e_description': ('django.db.models.fields.TextField', [], {'default': "'a'"}),
            'e_title': ('django.db.models.fields.CharField', [], {'default': "'a'", 'max_length': '128'}),
        ...
        u'gbe.genericevent': {
            'Meta': {'ordering': "['e_title']", 'object_name': 'GenericEvent', '_ormbases': [u'gbe.Event']},
        ...
        u'gbe.show': {
            'Meta': {'ordering': "['e_title']", 'object_name': 'Show', '_ormbases': [u'gbe.Event']},
