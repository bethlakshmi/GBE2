...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'gbe_event', 'description')

        # Deleting field 'Event.conference'
        db.delete_column(u'gbe_event', 'conference_id')

        # Deleting field 'Event.title'
        db.delete_column(u'gbe_event', 'title')

        # Deleting field 'Biddable.description'
        db.delete_column(u'gbe_biddable', 'description')

        # Deleting field 'Biddable.conference'
        db.delete_column(u'gbe_biddable', 'conference_id')

        # Deleting field 'Biddable.title'
        db.delete_column(u'gbe_biddable', 'title')


    def backwards(self, orm):
        # Adding field 'Event.description'
        db.add_column(u'gbe_event', 'description',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)

        # Adding field 'Event.conference'
        db.add_column(u'gbe_event', 'conference',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['gbe.Conference']),
                      keep_default=False)

        # Adding field 'Event.title'
        db.add_column(u'gbe_event', 'title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=128),
                      keep_default=False)

        # Adding field 'Biddable.description'
        db.add_column(u'gbe_biddable', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Biddable.conference'
        db.add_column(u'gbe_biddable', 'conference',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['gbe.Conference']),
                      keep_default=False)

        # Adding field 'Biddable.title'
        db.add_column(u'gbe_biddable', 'title',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=128),
                      keep_default=False)
