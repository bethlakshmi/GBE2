...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Costume.creator'
        db.delete_column(u'gbe_costume', 'creator')

        # Adding field 'Costume.act_title'
        db.add_column(u'gbe_costume', 'act_title',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Costume.debut_date'
        db.alter_column(u'gbe_costume', 'debut_date', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):
        # Adding field 'Costume.creator'
        db.add_column(u'gbe_costume', 'creator',
                      self.gf('django.db.models.fields.CharField')(default='creator', max_length=128),
                      keep_default=False)

        # Deleting field 'Costume.act_title'
        db.delete_column(u'gbe_costume', 'act_title')


        # Changing field 'Costume.debut_date'
        db.alter_column(u'gbe_costume', 'debut_date', self.gf('django.db.models.fields.CharField')(default='date', max_length=128))
    ...
    models = {
        ...
        u'gbe.costume': {
            ...
            'dress_size': ('django.db.models.fields.PositiveIntegerField', [], {}),
            ...
            'pieces': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'is_displaying'", 'to': u"orm['gbe.Profile']"})
        },
        u'gbe.cueinfo': {
