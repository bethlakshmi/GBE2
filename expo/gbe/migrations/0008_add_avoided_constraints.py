...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Class.avoided_constraints'
        db.add_column(u'gbe_class', 'avoided_constraints',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Class.avoided_constraints'
        db.delete_column(u'gbe_class', 'avoided_constraints')
