...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'gbe_showvote', (
            ...
            ('show', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gbe.Show'])),
    ...
    models = {
        ...
        'gbe.actbidevaluation': {
            'Meta': {'object_name': 'ActBidEvaluation'},
            'bid': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['gbe.Act']"}),
            'evaluator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['gbe.Profile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'primary_vote': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'primary__vote'", 'null': 'True', 'to': "orm['gbe.ShowVote']"}),
            'secondary_vote': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'secondary_vote'", 'null': 'True', 'to': "orm['gbe.ShowVote']"})
        },
        'gbe.audioinfo': {
        ...
        'gbe.showvote': {
            'Meta': {'object_name': 'ShowVote'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'show': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['gbe.Show']"}),
            'vote': ('django.db.models.fields.IntegerField', [], {})
        },
        'gbe.stageinfo': {
