...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GenericEvent.volunteer_category'
        db.delete_column(u'gbe_genericevent', 'volunteer_category')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'GenericEvent.volunteer_category'
        db.add_column(u'gbe_genericevent', 'volunteer_category',
