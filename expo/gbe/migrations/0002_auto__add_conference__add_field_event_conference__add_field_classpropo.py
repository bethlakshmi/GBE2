...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'gbe_event', 'conference',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gbe.Conference'], null=True),
                      keep_default=False)

        # Adding field 'ClassProposal.conference'
        db.add_column(u'gbe_classproposal', 'conference',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gbe.Conference'], null=True),
                      keep_default=False)
        ...
        # Adding field 'ConferenceVolunteer.conference'
        db.add_column(u'gbe_conferencevolunteer', 'conference',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gbe.Conference'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ClassProposal.conference'
        db.delete_column(u'gbe_classproposal', 'conference_id')

        # Deleting field 'Biddable.conference'
        db.delete_column(u'gbe_biddable', 'conference_id')

        # Deleting field 'ConferenceVolunteer.conference'
        db.delete_column(u'gbe_conferencevolunteer', 'conference_id')
    ...
    models = {
        ...
        u'gbe.biddable': {
            ...
            'conference': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gbe.Conference']", 'null': 'True'}),
        ...
        u'gbe.conference': {
            'Meta': {'object_name': 'Conference', '_ormbases': [u'scheduler.Schedulable']},
