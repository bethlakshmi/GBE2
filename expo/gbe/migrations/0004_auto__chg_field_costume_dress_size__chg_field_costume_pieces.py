...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Costume.dress_size'
        db.alter_column(u'gbe_costume', 'dress_size', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Costume.pieces'
        db.alter_column(u'gbe_costume', 'pieces', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Costume.dress_size'
        db.alter_column(u'gbe_costume', 'dress_size', self.gf('django.db.models.fields.PositiveIntegerField')(default='size'))

        # Changing field 'Costume.pieces'
        db.alter_column(u'gbe_costume', 'pieces', self.gf('django.db.models.fields.PositiveIntegerField')(default='pieces'))
