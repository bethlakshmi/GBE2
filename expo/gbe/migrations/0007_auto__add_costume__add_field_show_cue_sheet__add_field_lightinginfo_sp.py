...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Show.cue_sheet'
        db.add_column(u'gbe_show', 'cue_sheet',
                      self.gf('django.db.models.fields.CharField')(default='Theater', max_length=128),
                      keep_default=False)

        # Adding field 'LightingInfo.specific_needs'
        db.add_column(u'gbe_lightinginfo', 'specific_needs',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Show.cue_sheet'
        db.delete_column(u'gbe_show', 'cue_sheet')

        # Deleting field 'LightingInfo.specific_needs'
        db.delete_column(u'gbe_lightinginfo', 'specific_needs')
