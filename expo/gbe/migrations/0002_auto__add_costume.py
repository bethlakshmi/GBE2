...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'gbe_costume', (
            ...
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='is_displaying', to=orm['gbe.Profile'])),
            ...
            ('debut_date', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('active_use', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('pieces', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('pasties', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('dress_size', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ...
        db.send_create_signal(u'gbe', ['Costume'])
    ...
    models = {
        ...
        u'gbe.costume': {
            ...
            'debut_date': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
