...
existing_volunteer_msg = \
    "You've already offered to volunteer, would you like to update your proposal?"
default_window_schedule_conflict = "Your change caused a conflict.  You were scheduled for:"
